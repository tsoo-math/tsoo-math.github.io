...
## Theory
You may recall that in probability theory, we are given the distribution of a non-negative  integer-valued random variable $X$ and we *define* its mean **mean** to be 
