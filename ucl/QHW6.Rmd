...
Let $P$ be a transition matrix on a finite state space $S$ of size $n$.  Let $h :S \to \mathbb{R}$ be a function on $S$, and regard $h$ as a column vector.  Call a function $h$ **harmonic** if $Ph = h$.  
