...
*  This ICA is due UCL Week 27,  3 March 2021, 13:00 London Time.
*  This ICA is to be completed in a group of 3-4; each member of the group will receive the same grade.
*  Your groups must be disjoint from that of ICA2.
...
* Please hand in the html (or pdf file) and the Rmd source file.
