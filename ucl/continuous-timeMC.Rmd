...
Hence it is not hard to believe that 
...
$$
\begin{eqnarray*}
\frac{p_{ij}(t+h) - p_{ij}(t)}{h} &=& \frac{1}{h}\sum_{k} p_{ik}(t)p_{kj}(h) \\
&\approx&  \sum_{k} p_{ik}(t)q_{kj}  \\
&=&  [P(t)Q]{ij}
\end{eqnarray*}
$$
