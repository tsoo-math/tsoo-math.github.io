...
We can hope to obtain the standardized normal, by replacing the variance with the *sample* variance.
...
#  Version: `r format(Sys.time(), '%d %B %Y')`
  * [Rmd Source](https://tsoo-math.github.io/ucl/ica-stat9.Rmd)
