...
* Stochastic domination plays a key role in the Karlin-Rubin theorem [(1956)](https://www.jstor.org/stable/2236994), which is needed to extend the Neyman–Pearson lemma for composite hypotheses; that is, even testing $H_0: p=1/2$ against $H_1: p< \tfrac{1}{2}$, in the simple case of Bernoulli trials.
