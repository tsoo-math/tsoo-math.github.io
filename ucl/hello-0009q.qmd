...
* Download/Install [Quarto](https://tsoo-math.github.io/ucl3/quarto.html) the new and fancy version of R Markdown.  
...
Please send me an *html* file generated using R markdown (Quarto) with the following information.  It might be helpful to use the [hello-0009.qmd](https://tsoo-math.github.io/ucl/hello-0009q.qmd) as a template.
...
[qmd Source](https://tsoo-math.github.io/ucl/hello-0009q.qmd)
