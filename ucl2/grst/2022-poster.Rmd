...
plot(x4,y4, col = "purple",  pch=20, xlim=c(4,19), xlab = "Contact Terry Soo; t.soo@ucl.ac.uk", ylab=TeX(r'($\rho =0.816$)'), axes=FALSE, main="",  cex.main = 2,asp=1)
...
*   3.30 - 5.30 PM (Room to be confirmed)
