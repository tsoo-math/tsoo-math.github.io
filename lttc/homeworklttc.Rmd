...
* Using the general definition, the given in the notes in the section *Other spaces and spatial Poisson point processes* in the case of a Poisson point process on $[0, \infty)$, show that if there is exactly one point in $[0,1]$, then it is uniformly distributed.
...
* State a  Weierstrass approximation theorem for a continous function $f : [0,1] \times [0,1] \to \mathbb{R}$.   How would you prove such a theorem using probability?
