...
Given $\lambda_N > \lambda_Q >0$, show that there exists Poisson processes $N$ and $Q$, with rates $\lambda_N$ and $\lambda_Q$, respectively, such that $N(t) \geq Q(t)$ for all $t \geq 0$, and such that the first arrival for $N$ is always comes before the first arrival for $Q$.
...
* [Rmd Source](https://tsoo-math.github.io/ucl3/2022-ica3/release.Rmd)
