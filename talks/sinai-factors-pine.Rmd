---
title: "Sinai factors for nonsingular Bernoulli shifts"
author: "Terry Soo"
...
- Given iid systems: $(A^{\mathbb{Z}}, p^{\mathbb{Z}}, T)$ and $B(q) = (B^{\mathbb{Z}}, q^{\mathbb{Z}}, T)$
...
(Kosloff and Soo)
 ...
 Limiting marginal measure: $p_{|i|}(a) \to p$; Entropy: $H(p)$
