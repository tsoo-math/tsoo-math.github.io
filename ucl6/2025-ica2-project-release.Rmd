...
* This assessment is classified as Coursework as defined in UCL’s [Student Policies for Exams and Assessments.](https://www.ucl.ac.uk/academic-manual/chapters/chapter-4-assessment-framework-taught-programmes/student-policies-exams-and-assessments) It contributes 40% to the overall mark for this module.



* The release date for this assessment 5 Dec 2025.

* The submission deadline is 13:00 (UK time) 6 March 2026.
...
* You should expect to receive feedback on this assessment within 20 working days of the submission deadline. 
...
* The use of ChatGPT and related tools in *assisting* in the project ICA2 is permitted, in accordance with UCL’s [policy](https://www.ucl.ac.uk/students/exams-and-assessments/assessment-success-guide/engaging-ai-your-education-and-assessment)--[Category 2](https://www.ucl.ac.uk/teaching-learning/generative-ai-hub/three-categories-genai-use-assessment#:~:text=Category%202.&text=Students%20may%20not%20use%20GenAI,the%20development%20of%20specific%20skills).
  ...
  * The use of these tools often results in generic business like writing and presentation which is not appropriate  for this sort of academic work.
...
Each project should have a title and an abstract.  Do not use the description given in the project suggestions as your title.
...
* Queuing:  central versus individual queues:  does it make sense that banks use centralized queues and supermarkets often use individual  queues?  In fact, some supermarkets have a combination of individual and centralized queues; is there some optimal arrangement?
  * It is not hard to see that centralized queues are mathematically better.  Your project should explore issues beyond this mathematical observation.
...
* Applications of MCMC to Bayesian statistics:  discuss the basic Bayesian framework,  and how MCMC is applied, supporting the examples with code.  
  * Your project can build upon and should go beyond this [worksheet](https://tsoo-math.github.io/ucl4/week11-2023-inclass.html)
